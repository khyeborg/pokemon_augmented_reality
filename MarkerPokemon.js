class MarkerPokemon {
	...
	constructor(pokemonName, startX, startY, startZ, markerRotation) {
		this.container = new Container3D({x: startX, y: startY, z: startZ, rotationY: 0});
		...
		this.container.rotateX(this.markerRotation);
